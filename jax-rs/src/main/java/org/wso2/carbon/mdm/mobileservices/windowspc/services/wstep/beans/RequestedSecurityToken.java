...
@XmlType(name = "RequestedSecurityToken", namespace = Constants.CertificateEnrollment.WS_TRUST_TARGET_NAMESPACE,
		propOrder = { "binarySecurityToken" })
public class RequestedSecurityToken {

	@XmlElement(name = "BinarySecurityToken", required = true,
			namespace = Constants.CertificateEnrollment.WS_SECURITY_TARGET_NAMESPACE)
