...
package org.wso2.carbon.mdm.mobileservices.windowspc.services.wstep.util;
	...
	public boolean handleMessage(SOAPMessageContext context) {
		...
		if (outBoundProperty) {
			...
			QName qNamesSecurity = new QName(
					Constants.CertificateEnrollment.WS_SECURITY_TARGET_NAMESPACE,
			...
			try {
				attributeName = soapFactory.createName(Constants.CertificateEnrollment.TIMESTAMP_ID,
				                                       ...
				                                       Constants.CertificateEnrollment.
			...
			try {
				messageString = new String(outputStream.toByteArray(),
				                           Constants.CertificateEnrollment.UTF_8);
